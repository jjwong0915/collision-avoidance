...
def _depthwise_conv_block_v2(
    ...
    if depthwise_conv_filters > input_shape[channel_axis]:
        ...
        x = BatchNormalization(
            ...
            epsilon=bn_epsilon,
            name="conv_expand_%d_bn" % block_id,
        )(x)
...
def MNv2_segment_depth_multiloss_model(
    ...
    x = _depthwise_conv_block_v2(
        x, 64, alpha, expansion_factor, depth_multiplier, block_id=1
    )
    x = _depthwise_conv_block_v2(
        x, 64, alpha, expansion_factor, depth_multiplier, block_id=2
    )
    x = _depthwise_conv_block_v2(
        x, 64, alpha, expansion_factor, depth_multiplier, block_id=3
    )
    x = _depthwise_conv_block_v2(
        x, 64, alpha, expansion_factor, depth_multiplier, block_id=4
    )
    ...
    x = _depthwise_conv_block_v2(
        x, 32, alpha, expansion_factor, depth_multiplier, block_id=7
    )
    x = _depthwise_conv_block_v2(
        x, 32, alpha, expansion_factor, depth_multiplier, block_id=8
    )
    x = _depthwise_conv_block_v2(
        x, 32, alpha, expansion_factor, depth_multiplier, block_id=9
    )
    ...
    x = _depthwise_conv_block_v2(
        x, 24, alpha, expansion_factor, depth_multiplier, block_id=12
    )
    x = _depthwise_conv_block_v2(
        x, 24, alpha, expansion_factor, depth_multiplier, block_id=13
    )
    x = _depthwise_conv_block_v2(
        x, 24, alpha, expansion_factor, depth_multiplier, block_id=14
    )
    ...
    x = _depthwise_conv_block_v2(
        x, 16, alpha, expansion_factor, depth_multiplier, block_id=17
    )
    x = _depthwise_conv_block_v2(
        x, 16, alpha, expansion_factor, depth_multiplier, block_id=18
    )
