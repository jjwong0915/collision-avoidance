...
def getResult(model, image, shape):
    ...
    for i in range(4):
        ...
        depth[i] = (np.log2(depth[i])-np.log2(depth_min))*depth_max / (np.log2(depth_max)-np.log2(depth_min))
